...
memorialRoute.get(`${authUrl}memorials`, verifyToken,
                  memorialController.getMemorials);
memorialRoute.get(`${authUrl}memorial/:id`, verifyToken,
                  memorialController.getMemorial);
memorialRoute.get(`${authUrl}user-memorials`, verifyToken,
...
memorialRoute.delete(`${authUrl}delete-memorial`, verifyToken,
